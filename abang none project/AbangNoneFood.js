const katalog = {
  ...
  camilan: [
    ...
    { nama: "Kue Lumpur", harga: 25000, gambar: "Camilan/lumpur.jpg", deskripsi: "Terbuat dari kentang, santan, dan telur – teksturnya lembut dan manis." },
    { nama: "Kue Rangi", harga: 25000, gambar: "Camilan/rangi.jpg", deskripsi: "Kelapa parut dipanggang, disiram saus gula merah." },
    { nama: "Kue Talam", harga: 25000, gambar: "Camilan/talam.jpg", deskripsi: "Dua lapis – lapisan atas santan, bawah gula merah atau ubi." },
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (namaUser) {
        document.getElementById('user-nama').textContent = `🫅 ${namaUser}`;
    }

    const alamat = localStorage.getItem('alamatPengiriman');
    const wilayah = localStorage.getItem('wilayahJakarta');
    if (alamat && wilayah) {
        document.getElementById('alamat-info').textContent = `📍 ${alamat}, ${wilayah}`;
    }
